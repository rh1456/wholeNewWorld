...
namespace wholeNewWorld
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Console.WriteLine($"{name}, Think of a number between {lower} and {upper}, enter time, in seconds needed to think and press enter");
      int waitTime = Console.ReadLine();
      Console.WriteLine($"Alright its been {waitTime}seconds got it? Answer yup or nope");
