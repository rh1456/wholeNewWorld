...
namespace wholeNewWorld
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Console.WriteLine($"{name}, Think of a number between {lower} and {upper}, press enter to continue");
      var waitTime = Console.ReadLine();
      Console.WriteLine($"Alright {name} how")
      Console.WriteLine("Alright got it's been ");
